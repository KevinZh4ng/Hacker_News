...
class User {
  ...
  async addStory(story) {
    ...
    await this.favoriteState("add", story);
  }
  ...
  async deleteStory(story) {
    ...
    await this.favoriteState("delete", story);
  }


  async favoriteState(newState, story) {
    let method = "";
    if (newState === "add") {
      method = "POST"
    }
    else if (newState === "delete") {
      method = "DELETE"
    }
    await axios({
